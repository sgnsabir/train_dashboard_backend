...
@Slf4j
@Component
public class HaugfjellMP1AxlesRepositoryCustomImpl implements HaugfjellAxlesRepositoryCustom {
    ...
    public HaugfjellMP1AxlesRepositoryCustomImpl(DatabaseClient db) {
        this.db = db;
    }
