...
public interface HaugfjellMP1AxlesRepository extends R2dbcRepository<HaugfjellMP1Axles, Integer> {
    ...
    @Query("SELECT AVG((vfrcl_tp1 + vfrcl_tp2 + vfrcl_tp3 + vfrcl_tp5 + vfrcl_tp6 + vfrcl_tp8)/6.0) FROM haugfjell_mp1_axles WHERE train_no = :analysisId")
    Mono<Double> findAverageVerticalForceLeftByTrainNo(Integer analysisId);

    @Query("SELECT AVG((vfrcr_tp1 + vfrcr_tp2 + vfrcr_tp3 + vfrcr_tp5 + vfrcr_tp6 + vfrcr_tp8)/6.0) FROM haugfjell_mp1_axles WHERE train_no = :analysisId")
