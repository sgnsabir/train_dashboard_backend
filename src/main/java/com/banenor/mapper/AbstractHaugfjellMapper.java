...
public interface AbstractHaugfjellMapper<H, A> {
    ...
    @Mappings({
            @Mapping(target = "trainNo", ignore = true), // Auto-generated by DB.
            @Mapping(target = "createdAt", ignore = true), // Set on persist.
            // Map time fields using conversion method.
            ...
            // Correct property names (case sensitive) for temperature/pressure/humidity.
            ...
            // All other header fields (mstation, mplace, cooLat, cooLong, trackKm, trackM,
            // allTpsInfo, aversion, rversion, td, rfidDevs) are mapped automatically.
    })
    ...
    default java.sql.Timestamp localDateTimeToTimestamp(java.time.LocalDateTime localDateTime) {
